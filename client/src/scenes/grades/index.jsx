        ...
        courses.map(async (course) => {
          try {
            ...
            const allGraded = response.data.every(
              (student) => student["M1_GRADE"] && student["M2_GRADE"] && student["M3_GRADE"]
            );
              ...
              <TableBody>
                {studentData.map((student) => (
                  <TableRow hover role="checkbox" tabIndex={-1} key={student._id}>
                    ...
                    <TableCell>{student["M1_GRADE"]}</TableCell>
                    <TableCell>{student["M2_GRADE"]}</TableCell>
                    <TableCell>{student["M3_GRADE"]}</TableCell>
                    <TableCell>{student.GRADEVISIBILITY}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
